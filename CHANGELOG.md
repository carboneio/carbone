...
## v4.23.0
  ...
  - A new option `{o.useHighPrecisionArithmetic=true}` can be used within a template to activate arbitrary-precision decimal arithmetic for specific mathematical operations. 
    ...
    Support for aggregators, `:abs`, `:mod`, and mathematical expressions and conditions will continue to be enhanced in upcoming releases.
