...
var builder = {
      ...
      parser.findVariables(xmlWithoutTranslation, options.existingVariables, function (err, xmlWithoutVariable, variables) {
        ...
        parser.findMarkers(xmlWithoutVariable, function (err, xmlWithoutMarkers, markers) {
          ...
          parser.preprocessMarkers(markers, variables, function (err, preprocessedMarkers) {
            ...
            var _builder;
            try {
              // console.log(preprocessedMarkers);
              ...
              // console.log(_descriptor.dynamicData._rootdmodules);
              // console.log(_descriptor.dynamicData._rootdmodulesobservationsi__0);
              // console.log(_descriptor.dynamicData._rootdmodulesobservationsi__0.conditions);
              ...
              // console.log('Dictionary: ', _builder.builderDictionary);
              // _xmlParts = [ { pos : [ 0 ], str : '', bef : 0 },
              //   { pos : [ 13, 0, 57 ], str : '1', rowShow : true, aft : 7 },
              //   { pos : [ 13, 0, 13 ], str : '', rowStart : true, aft : 8 },
              //   { pos : [ 13, 0, 158 ], str : '', bef : 9, rowEnd : true },
              //   { pos : [ 13, 0, 112 ], str : '', rowShow : true },
              //   { pos : [ 13, 1, 57 ], str : '2', rowShow : true, aft : 7 },
              //   { pos : [ 13, 1, 13 ], str : '', rowStart : true, aft : 8 },
              //   { pos : [ 13, 1, 158 ], str : '', bef : 9, rowEnd : true },
              //   { pos : [ 13, 1, 112 ], str : 'foo', rowShow : true },
              //   { pos : [ 13, 2, 57 ], str : '3', rowShow : true, aft : 7 },
              //   { pos : [ 13, 2, 13 ], str : '', rowStart : true, aft : 8 },
              //   { pos : [ 13, 2, 158 ], str : '', bef : 9, rowEnd : true },
              //   // { pos : [ 13, 2, 112 ], str : 'foo', rowShow : true },
              //   { pos : [ 159 ], str : '', aft : 12 } ];
            }
            catch (e) {
            ...
            postprocessor.update(data, options, function (err) {
              ...
              var _xmlResult = builder.assembleXmlParts(_xmlParts, 20, _builder.builderDictionary, options); // TODO -> adapt the depth of the sort according to the maximum depth in _xmlParts
  ...
  getFilterString : function (getSafeVar, getSafeValue,  conditions, codeIfTrue, prefix, inverseCondition, forceObjectTested) {
    ...
    var _str = '';
    // _str += 'console.log("getFilterString", "'+codeIfTrue+'");\n';
    ...
    _str += codeIfTrue +';\n';
    _str += ' }';
    // console.log(_declareStr + _str, codeIfTrue);
  ...
  assembleXmlParts : function (arrayOfStringPart, sortDepth, builderDictionary, options) {
    ...
    for (var i = 0; i < arrayOfStringPart.length; i++) {
      ...
      if (!(_hideBlock > 0 && _prevHideBlock === 0)) {
        // Execute postProcess formatters or inject string
        _str += _part.postProcess === undefined ? _part.str : _part.postProcess.fn.apply(options, _part.postProcess.args);
  ...
  getBuilderFunction : function (descriptor, existingFormatters) {
    ...
    _code.add('init', '// init dynamic variables\n');
    ...
    for (var _objIndex = 0; _objIndex < _hierarchy.length; _objIndex++) {
      _code.add('prev', 'main', '// For each object, generate the code\n');
      ...
      _code.add('prev', 'main', `// Object name: ${_objName} type: ${_type}\n`);
      // Object type
      if (_type === 'object') {
        ...
        // _code.add('prev', 'main', 'console.log("Value here A (Object in array)"+'+_arrayOfObjectNameG+', "Parent variable:", '+_getSafeVar(_objParentName)+', "_realObjName:", '+_realObjName+');\n');
        // _code.add('prev', 'main', 'console.log("Value here B", '+_arrayOfObjectNameG+');\n');
      ...
      // Array type
        ...
        // _code.add('prev', 'main', 'console.log("Value here A (Array)");\n');
      ...
      for (var i = 0; i < _xmlParts.length; i++) {
        ...
        var _dataType = _xmlPart.type || 'string';
        ...
        // _code.add('main', 'console.log(_strPart);');
        ...
        if (_dataAttr) {
          ...
          // _code.add('main', 'console.log("Value here C:", "Value: "+ _str, "Variable:'+_getSafeVar(_dataObj)+'", "Dictionary:'+_getSafeValue(_dataAttr)+'", "Marker:"+ '+_getSafeValue(_dataAttr)+');');
          // console.log(i, 'DataOBJ:', _dataObj, _getSafeVar(_dataObj));
          ...
          _code.add('main', "if('"+_dataType+"' === 'string' && typeof(_str) === 'string') {\n");
        ...
        // _code.add('main', "console.log('Loop number:', "+i+', _strParts);');
      }
    }
    ...
    // console.log(_fn.toString());
    // tmpBuilder.builderDictionary = _safeAccessor.getDictionary();
    // return tmpBuilder;
    return _fn;
  }
