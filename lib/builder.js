  ...
  getBuilderFunction : function(descriptor){
    ...
    for (var _objIndex = 0; _objIndex < _hierarchy.length; _objIndex++) {
      ...
      //Array type
        ...
        _str += "_xmlPos["+(_arrayDepth*2-2)+"] = "+_posStart+";\n";
        _str += "_xmlPos["+(_arrayDepth*2-1)+"] = "+_posStart+";\n";
        ...
        if(_beforeStr !== undefined && _beforeStr !== ''){
          _str += "_strPart = {\n";
          _str += "  'pos' :  _xmlPos.slice(0, "+(_arrayDepth*2-1)+"),\n";
          _str += "  'str' : '"+_beforeStr + "'\n";
          _str += "};\n";
          _str += "_strParts.push(_strPart);\n";
        }
        ...
        _str += "  _xmlPos["+(_arrayDepth*2-1)+"] = "+_arrayIndexName+";\n";
      ...
      for (var i = 0; i < _xmlParts.length; i++) {
        ...
        _str += "_xmlPos["+(_partDepth*2)+"] = "+_xmlPart.pos+";\n";
        _str += "_strPart = {\n";
        _str += "  'pos' : _xmlPos.slice(0, "+(_partDepth*2+1)+"),\n";
        _str += "  'str'    : ''\n";
        _str += "};\n";
        if(_xmlPart.before){
        ...
        if(_dataAttr){
          ...
          _str += "  _str = _str.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/'/g, '&apos;').replace(/\"/g, '&quot;');\n";
          _str += "};\n";
