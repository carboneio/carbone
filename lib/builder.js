  ...
  getBuilderFunction : function (descriptor, existingFormatters) {
    ...
    for (var _objIndex = 0; _objIndex < _hierarchy.length; _objIndex++) {
      ...
      if (_type === 'object') {
        ...
        _code.add('prev', 'main', that.getFilterString(_getSafeVar, _getSafeValue, _conditionToFindObject, _foundCode , _objNameTemp, false, _objNameTemp));
        ...
        for (var it = 0; it < _iterators.length; it++) {
          ...
          if (_iterator.attr === 'i') {
            ...
            if ( _repeater ) {
              ...
              _code.add('prev', 'main', ' if ( '+_repeaterName+' > 100 ) { throw Error("The repeater cannot be above 100"); }\n');
              // TODO
