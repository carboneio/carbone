    ...
    while ((xmlStyleColorTag = _regexStyleColor.exec(file.data)) !== null) {
      if (
        ...
        if (_hasDynColor === true) {
          ...
          _colors = _colors.sort(function (a, b) {
            if (NODE_VERSION < 11 && ((!!a.marker === false && !!b.marker === true) || (!!b.marker === true && b.marker.indexOf('[') !== -1 ))) {
              return 1;
            }
            if (NODE_VERSION >= 11 && ((!!a.marker === true && !!b.marker === false) || (!!a.marker === true && a.marker.indexOf('[') !== -1 ))) {
              return -1;
            }
            return 0;
          });
