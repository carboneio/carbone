...
const color = {
  ...
  preProcessLo : function (template, options) {
    ...
    color.getBindColorMarkers(_file.data, function (
      ...
      const _colorStyleList = color.getColorStyleListLo(fileContentFromGetBindColor, bindColorList);
      ...
      for (let i = 0, j = _colorStyleListKeys.length; i < j; i++) {
        ...
        fileContentFromGetBindColor = fileContentFromGetBindColor.replace(_regElementStyleAttribute, function (xml, tagType) {
