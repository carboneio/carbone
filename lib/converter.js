        ...
        if (_job.returnLink===true || _job.error !== null) {
          ...
          fs.readFile(_job.outputFilePath, function (err, content) {
            ...
            if (params.factoryMemoryCheck === true) {
              ...
              _factory.nbrReports++;
              const _totalReportsMemoryLoaded = _factory.nbrReports * params.factoryMemoryFileSize;
              const _totatMemoryAvailableMB = os.totalmem() / 1024 / 1024; // get the total memory available in MB
              const _percentageFactoryMemoryLoaded = _totalReportsMemoryLoaded * 100 / _totatMemoryAvailableMB;
