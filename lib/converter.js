...
var converter = {
  ...
  exit : function (callback) {
    ...
    for (var i in conversionFactory) {
      ...
      // If the LibreOffice thread was starting, kill after it has started
      if (_factory?.isStarting === true) {
      ...
      else if (_factory && (_factory.pythonThread !== null || _factory.officeThread !== null )) {
...
function addConversionFactory (callback) {
  ...
  for (var i = 0; i < params.factories; i++) {
    ...
    else if (_prevFactory.pythonThread === null && _prevFactory.officeThread === null && _prevFactory.isStarting === false) {
      _startListenerID = i;
      break;
    }
  }
  ...
  const _factory = {
    ...
    officeThread  : null,
    pythonThread  : null,
    isStarting    : true, // let us the time to create config file with initLibreOfficeUserConfig
    isReady       : false,
    isConverting  : false,
 ...
 *
 * Default user configuration location on:
 * - MacOS /Users/username/Library/Application Support/LibreOffice/4/user/registrymodifications.xcu
 *
 ...
 *
 * @param {String}    parentPath  The path where Libreoffice read the user configuration
 * @param {Function}  callback    callback when the configuration is initialized
 */
function initLibreOfficeUserConfig (parentPath, callback) {

  // header
  let _defaultConfig = '<?xml version="1.0" encoding="UTF-8"?>';
  _defaultConfig += '<oor:items xmlns:oor="http://openoffice.org/2001/registry" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">';

  // Fix charts when converting a DOCX to PDF. If the document contains more charts, charts are distorted / blurry (20 by default)
  // will become useless when this bug will be solved: https://bugs.documentfoundation.org/show_bug.cgi?id=155645
  _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Cache/Writer"><prop oor:name="OLE_Objects" oor:op="fuse"><value>500</value></prop></item>';
  ...
  _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Cache/DrawingEngine"><prop oor:name="OLE_Objects" oor:op="fuse"><value>500</value></prop></item>';
  ...
  _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/VCL"> <prop oor:name="PDFExportImageCacheSize" oor:op="fuse"> <value>50</value></prop></item>';
  // when exporting DOCX to HTML, embed images in the HTML instead of creating external links (works only with xhtml export)
  _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Filter/HTML/Export"><prop oor:name="LocalGraphic" oor:op="fuse"><value>false</value></prop></item>';

  if (params.securityLevel & helper.SECURITY_LO_DISABLE_USELESS_FEATURE) {
    // Determines if the user has access to the entire configuration via the Expert Configuration button.
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security"><prop oor:name="EnableExpertConfiguration" oor:type="xs:boolean" oor:op="fuse"><value>false</value></prop></item>';
    // Contains a list of URLs that should be accessed using system credentials of the user (none)
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Passwords"><prop oor:name="AuthenticateUsingSystemCredentials" oor:op="fuse" oor:type="oor:string-list"/></item>';
    // Specifies if authentication using system credentials should be tried automatically for all resources that support it
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Passwords"><prop oor:name="TrySystemCredentialsFirst" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop></item>';
    // do not store password
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Passwords"><prop oor:name="UseStorage" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop></item>';
    // list of URL using system credential (NONE)
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Passwords"><prop oor:name="AuthenticateUsingSystemCredentials" oor:op="fuse" oor:type="oor:string-list"/></item>';
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Passwords"><prop oor:name="TrySystemCredentialsFirst" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop></item>';
    // No auto update
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Jobs/Jobs/org.openoffice.Office.Jobs:Job[\'UpdateCheck\']/Arguments"><prop oor:name="AutoCheckEnabled" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop></item>';
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Jobs/Jobs/org.openoffice.Office.Jobs:Job[\'UpdateCheck\']/Arguments"><prop oor:name="ExtendedUserAgent" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop></item>';
    // Disable extension installation
    _defaultConfig += '<item oor:path="/org.openoffice.Office.ExtensionManager/ExtensionSecurity"><prop oor:name="DisableExtensionInstallation" oor:op="fuse" oor:type="xs:boolean"><value>true</value></prop></item>';
    _defaultConfig += '<item oor:path="/org.openoffice.Office.ExtensionManager/ExtensionSecurity"><prop oor:name="DisableExtensionRemoval" oor:op="fuse" oor:type="xs:boolean"><value>true</value></prop></item>';
    // disable automatic installation of (font, lang, ...)
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/PackageKit"><prop oor:name="EnableFontInstallation" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop> </item>';
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/PackageKit"><prop oor:name="EnableLangpackInstallation" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop> </item>';
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/PackageKit"><prop oor:name="EnableBaseInstallation" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop></item>';
    // disable usage collection
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Misc"><prop oor:name="CrashReport" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop></item>';
  }

  if (params.securityLevel & helper.SECURITY_LO_REMOVE_PERSONAL_INFO) {
    // Removes author, revision author and commments?
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting"><prop oor:name="RemovePersonalInfoOnSaving" oor:op="fuse" oor:type="xs:boolean"><value>true</value></prop></item>';
  }

  if (params.securityLevel & helper.SECURITY_LO_DISABLE_EXTERNAL_LINK) {
    // disable automatic download of external images and Fix CVE-2018-10583 https://www.libreoffice.org/about-us/security/advisories/cve-2018-10583/
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting"><prop oor:name="BlockUntrustedRefererLinks" oor:op="fuse" oor:type="xs:boolean"><value>true</value></prop></item>';
  }

  if (params.securityLevel & helper.SECURITY_LO_DISABLE_SCRIPT_EXECUTION) {
    // Highest macro security. Default 3
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting"><prop oor:name="MacroSecurityLevel" oor:op="fuse" oor:type="xs:int"><value>3</value></prop></item>';
    // Deactivate macro
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting"><prop oor:name="DisableMacrosExecution" oor:op="fuse" oor:type="xs:boolean"><value>true</value></prop></item>';
    // Never handle Office Basic scripts
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting"><prop oor:name="OfficeBasic" oor:op="fuse" oor:type="xs:int"><value>0</value></prop></item>';
    // Specifies whether execution of plugins found inside a document is allowed
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting"><prop oor:name="ExecutePlugins" oor:op="fuse" oor:type="xs:boolean"><value>false</value></prop></item>';
    // Warn on load when a document binds an event to a macro (no warning, keep on, macro are disabled)
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting"><prop oor:name="CheckDocumentEvents" oor:op="fuse" oor:type="xs:boolean"><value>true</value></prop></item>';
    // List of script URLS which are allowed to be called by document events (NONE, ex: vnd.sun.star.script:Standard.Module1)
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting"><prop oor:name="AllowedDocumentEventURLs" oor:op="fuse" oor:type="oor:string-list"/> </item>';
    // List of safe file path to execute macro (none)
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting" oor:type="oor:string-list"><prop oor:name="SecureURL" oor:op="fuse"/></item>';
  }
  if (params.securityLevel & helper.SECURITY_LO_DISABLE_EXOTIC_FILE) {
    ...
    _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security"><prop oor:name="LoadExoticFileFormats" oor:op="fuse" oor:type="xs:int"><value>0</value></prop></item>';
  }
  ...
  // _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Cache/GraphicManager"><prop oor:name="GraphicMemoryLimit" oor:op="fuse"><value>30000000</value></prop></item>';
  ...
  _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Cache/Font"><prop oor:name="GlyphsCacheSize" oor:op="fuse"><value>150000000</value></prop></item>';
  ...
  // _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Cache/Font"><prop oor:name="TextRunsCacheSize" oor:op="fuse"><value>100000</value></prop></item>';
  ...
  // _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Cache/Skia"><prop oor:name="ImageCacheSize" oor:op="fuse"><value>64000000</value></prop></item>';
  //  TODO: Without time servers, we cannot create signed PDF with hashed timestamp?
  // _defaultConfig += '<item oor:path="/org.openoffice.Office.Common/Security/Scripting"> <prop oor:name="TSAURLs" oor:op="fuse" oor:type="oor:string-list"> <value> <it>http://zeitstempel.dfn.de</it> <it>https://freetsa.org/tsr</it> </value> </prop> </item>';  

  // footer
  _defaultConfig += '</oor:items>';
