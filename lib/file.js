...
var file = {
   ...
   * @param  {String}   templateId               template name (without the path)
  ...
  openTemplate : function(templateId, callback){
    ...
    var _templateFile = path.join(params.templatePath, templateId);
   ...
   * @param  {Function} callback(err, data) data ca be a buffer (docx,...) or a string (xml)
   */
