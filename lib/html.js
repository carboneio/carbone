  ...
  buildXmlContentDOCX : function (descriptor, options, styleId = '') {
    ...
    for (let i = 0, j = descriptor.length; i < j; i++) {
      ...
      if (descriptor[i].type === html.types.BREAK_LINE) {
        ...
        _content.add(`<w:r><w:drawing><wp:anchor behindDoc="0" distT="0" distB="0" distL="0" distR="0" simplePos="0" locked="0" layoutInCell="0" allowOverlap="1" relativeHeight="2">
          ...
          <wp:extent cx="1108710" cy="1663065"/>
          ...
          _content.add(`" name="" descr=""></pic:cNvPr>
                ...
                <pic:blipFill>
                  <a:blip r:embed="`);
          _content.add(imageFormatters.generateImageDocxReference.call(options, descriptor[i].src, 'content.xml'));
          _content.add(`"></a:blip>
                  <a:stretch>
                    <a:fillRect/>
                  </a:stretch>
