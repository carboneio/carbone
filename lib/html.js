...
/**
 * TODO - ODT Header Footer - Reappliquer le style du template:
 * - [X] getTemplateDefaultStyles: parser tous les attributs="value" des paragraphs dans la feuille de styles <style:paragraph-properties
 * - [x] buildXMLContentOdt: construire un nouveau style pour le paragraph, avec un nouvel ID unique, et ajouter à la variable "style"
 * - [x] fo:font-style= fait crasher
