...
const DEFAULT_IMAGE_ON_ERROR = {
  data      : new Buffer.from('', 'base64'),
  extension : 'svg',
...
const image = {
  ...
  defineImageContentTypeDocx : function (template, imageExtensions) {
    ...
    for (let i = 0, j = imageExtensions.length; i < j; i++) {
      const _extension = imageExtensions[i];
      // Check to do not include the type definition multiple times, otherwise Word won't open the report
      if (_file.data.indexOf(`Extension="${_extension}"`) === -1 &&
          _imageTypeXml.indexOf(`Extension="${_extension}"`) === -1 &&
          Object.prototype.hasOwnProperty.call(image.extensionList, _extension)) {
