...
const image = {
  ...
  _computeImageSize (imageInfo) {
    if (!imageInfo?.imageWidth || !imageInfo.imageHeight ||
      ...
      /**
       * Case happenning when the image is coming the HTML marker
       * No default image canva (temporary image) is available
      */
      //  29.7 x 21
      imageInfo.imageWidth = imageInfo.newImageWidth < 30 ? 10 : imageInfo.newImageWidth;
      imageInfo.imageHeight = imageInfo.newImageHeight < 30 ? 10 : imageInfo.newImageWidth;
      // return;
    }
