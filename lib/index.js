...
carbone.addFormatters(require('../formatters/aggregator.js'));
...
carbone.addFormatters(require('../formatters/chart.js'));
carbone.addFormatters(require('../formatters/hyperlinks.js'));
carbone.addFormatters(require('../formatters/color.js'));
carbone.addFormatters(require('../formatters/html.js'));
carbone.addFormatters(require('../formatters/form.js'));
translator.loadTranslations(params.templatePath);
