...
function parseOptions (options, callbackFn, callback) {
  ...
  parser.findVariables(options.variableStr, function (err, str, variables) {
    var _options = {
      ...
      hyperlinkDatabase : new Map(), // hyperlinks
...
function convert (data, convertTo, options, callback) {
  ...
  var _exportFilters = _fileFormatOutput.indexOf('pdf') !== -1 || _fileFormatOutput.indexOf('png') !== -1 || _fileFormatOutput.indexOf('jpg') !== -1 ? options.formatOptions : {};
