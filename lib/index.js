...
var carbone = {
  ...
  generateOutputFilename : function (renderPath, renderPrefix, finalReportName, extension) {
    ...
    var _filename = renderPrefix + '_' + encodeURIComponent(`${finalReportName}.${extension}`);
            ...
            file.buildFile(report, function (err, result) {
              ...
              if (typeof(options.convertTo) === 'string' && options.convertTo !== '') {
                ...
                if (_outputFilename.length > 0) {
                  return fs.writeFile(_outputFilename, data, function (err) {
                    callback(err, _outputFilename, report.reportName);
                  });
                }
...
function parseOptions (options, callbackFn, callback) {
  ...
  if (typeof(options.complement) !== 'object') {
    options.complement = {};
  }
  if (!options.complement.now) {
    Object.defineProperty(options.complement, 'now', {
