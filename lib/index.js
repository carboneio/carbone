...
var carbone = {
  ...
  buildXML : function(xml, data){
    ...
    var _dynamicDescriptor = analyzer.decomposeMarkers(_separateMarkersAndXML.markers);
    var _descriptor = parser.extractXmlParts(_separateMarkersAndXML.xml, _dynamicDescriptor);
