...
module.exports  = {
  ...
  startFactory           : false,
  /* If true, it monitors the LibreOffices memory process and kill if it reachs a threshold */
  factoryMemoryCheck     : true,
  /* approximated memory size of a report loaded in memory by a LO process, unit: MegaBytes */
  factoryMemoryFileSize  : 20,
  /* percentage threshold of used memory to kill a LibreOffice process */
