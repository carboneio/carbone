...
module.exports  = {
  ...
  egressMaxRetry          : 0,
  egressIssuerFilter      : [4,1717,3293],
  ...
  // port     : 443
  // issuer   : JWT issuer if used. 0 by default.
  // rui      : Unique id generated for each new request received by Carbone Webserver. 0 by default
  egressProxyPathFormat   : '{path}', // rewrite URL:  /${protocol}/${hostname}/${port}/${issuer}/${ruid}${path}
