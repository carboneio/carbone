...
var _langFilePath =  path.resolve(tmpDir+'/lang/', _lang+'.json');
var _objLang = {};
if(fs.existsSync(_langFilePath)){
  langData = fs.readFileSync(_langFilePath, 'utf8');
  _objLang = JSON.parse(langData);
}
