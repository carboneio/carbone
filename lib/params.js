...
module.exports  = {
  ...
  studio                  : false,
  studioUser              : 'admin:pass',               // Format: "admin:password". Deactivate studio basic authentication if empty or undefined
  ...
  /** Time interval to clean the `/template` and `/render` directories */
  cleanIntervalTime       : 60 * 60 * 1000,
