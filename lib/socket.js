...
var Socket = function(port, host, timeout, reconnectInterval){
  ...
  function stop(callback){
    if(_client!==null){
      ...
      //_server.close(callback); This line does not work but it isnot a problem because _server.unref() has been called earlier
    }
  }
  ...
  function startServer(callback){
    ...
    _server.unref(); //close connections when program exit
