...
function initWorkingDirectory () {
  ...
  try { fs.mkdirSync(params.templatePath, { recursive: true, mode: 0o700 }); } catch (e) {}; // eslint-disable-line
  try { fs.mkdirSync(params.renderPath  , { recursive: true, mode: 0o700 }); } catch (e) {}; // eslint-disable-line
  try { fs.mkdirSync(params.assetPath   , { recursive: true, mode: 0o700 }); } catch (e) {}; // eslint-disable-line
  try { fs.mkdirSync(params.configPath  , { recursive: true, mode: 0o700 }); } catch (e) {}; // eslint-disable-line
  try { fs.mkdirSync(params.pluginPath  , { recursive: true, mode: 0o700 }); } catch (e) {}; // eslint-disable-line
  ...
  try {
    ...
    fs.writeFileSync(params.pythonPath, _pythonCode, { mode : 0o700 });
  }
  catch (e) {
  ...
  fs.writeFileSync(configFile, JSON.stringify(_defaultConfig, null, 2), { mode : 0o700 });
  return {};
}
