...
const errorCode = {
  ...
  w103 : () => 'Template format not supported',
  w104 : () => 'File not found',
  ...
  w115 : () => 'Invalid or undefined TemplateId or RenderId in the URL',
  w116 : () => 'Cannot read template',
  w117 : () => 'Error while setting up the webhook',
  w118 : () => 'Template format not supported, it must be an XML-based document: DOCX, XLSX, PPTX, ODT, ODS, ODP, XHTML, HTML or an XML file',
  w119 : () => `Template too large, the file size limit is ${params.maxTemplateSize/1024/1024} MB`
};
