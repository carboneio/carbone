...
describe('chart', function () {
  ...
  describe('[Full test] DOCX', function () {
    ...
    it('should update two charts with the same data', function (done) {
      const _data = [
        { label : 'row1' , valCol1 : 10 , valCol2 : 100.1 },
        { label : 'row2' , valCol1 : 20 , valCol2 : 200.2 },
        { label : 'row3' , valCol1 : 30 , valCol2 : 300.3 }
      ];
      const _testedReport = 'chart/docx-two-charts';
      carbone.render(helperTest.openTemplate(_testedReport), _data, (err, res) => {
        helperTest.assert(err+'', 'null');
        helperTest.assertFullReport(res, _testedReport);
        done();
  ...
  describe('[Full test] ODP', function () {
    it('should replace markers in charts', function (done) {
      ...
      const _testedReport = 'chart/odp-simple';
      carbone.render(helperTest.openTemplate(_testedReport), _data, (err, res) => {
        helperTest.assert(err+'', 'null');
        helperTest.assertFullReport(res, _testedReport);
        done();
    ...
    it('should not break reports with two charts, if <draw:object is not a self-closing tag', function (done) {
      const _data = [
        { label : 'row1' , valCol1 : 10 , valCol2 : 100.1 },
        { label : 'row2' , valCol1 : 20 , valCol2 : 200.2 },
        { label : 'row3' , valCol1 : 30 , valCol2 : 300.3 }
      ];
      const _testedReport = 'chart/odp-two-charts';
      carbone.render(helperTest.openTemplate(_testedReport), _data, (err, res) => {
        helperTest.assert(err+'', 'null');
        helperTest.assertFullReport(res, _testedReport);
        done();
  ...
  describe('[Full test] PPTX', function () {
    ...
    it('should update multiple charts on multiple slides', function (done) {
      const _data = [
        { label : 'row1' , valCol1 : 10 , valCol2 : 100.1 },
        { label : 'row2' , valCol1 : 20 , valCol2 : 200.2 },
        { label : 'row3' , valCol1 : 30 , valCol2 : 300.3 }
      ];
      const _testedReport = 'chart/pptx-two-charts';
      carbone.render(helperTest.openTemplate(_testedReport), _data, (err, res) => {
        helperTest.assert(err+'', 'null');
        helperTest.assertFullReport(res, _testedReport);
        done();
