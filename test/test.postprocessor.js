...
describe('postprocessor', function () {
  describe('File type checking', function () {
    it('Throw an error when the file type is not defined on the filename extension and the option object.', function (done) {
      const template = {
        isZipped   : true,
        filename   : './template',
        embeddings : [],
      ...
      postprocessor.execute(template, data, options, function (err, response) {
    ...
    it('Return a valid template through the file type defined on the file name extension', function (done) {
      const template = {
        isZipped   : true,
    ...
    it('Return a valid template through the file type defined on the option object.', function (done) {
      const template = {
        isZipped   : true,
        filename   : './template',
        embeddings : [],
