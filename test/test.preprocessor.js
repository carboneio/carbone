...
describe('preprocessor', function () {
  ...
  describe('execute', function () {
    ...
    describe.only('Dynamic pictures preprocessing ODT ONLY', function () {
      ...
      describe('prepareOpenDocumentImage', function () {
        ...
        it('should replace pictures link by alt text marker and add special formatter generateOpenDocumentImageHref', function (done) {
          ...
          var _expected = '<xml><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Image1" text:anchor-type="paragraph" svg:x="0.03cm" svg:y="0.007cm" svg:width="{d.dog:scaleImageLo(width, 5.87, cm)}" svg:height="{d.dog:scaleImageLo(height, 3.302, cm)}" draw:z-index="0">'
        ...
        it('should leave other markers in alternative text and take into account only the first marker for image', function (done) {
          ...
          var _expected = '<xml><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Image1" text:anchor-type="paragraph" svg:x="0.03cm" svg:y="0.007cm" svg:width="{d.dog:scaleImageLo(width, 5.87, cm)}" svg:height="{d.dog:scaleImageLo(height, 3.302, cm)}" draw:z-index="0"><draw:image xlink:href="{d.dog:generateOpenDocumentImageHref()}" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/><svg:title>  {d.altText}</svg:title></draw:frame></text:p></xml>';
          var _report = {
            embeddings : [],
            extension  : 'odt',
            files      : [
        ...
        it('should replace pictures alt text marker in styles file also', function (done) {
          ...
          var _expected = '<xml><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Image1" text:anchor-type="paragraph" svg:x="0.03cm" svg:y="0.007cm" svg:width="{d.dog:scaleImageLo(width, 5.87, cm)}" svg:height="{d.dog:scaleImageLo(height, 3.302, cm)}" draw:z-index="0"><draw:image xlink:href="{d.dog:generateOpenDocumentImageHref()}" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/><svg:title></svg:title></draw:frame></text:p></xml>';
          var _report = {
            embeddings : [],
            extension  : 'odt',
            files      : [
        ...
        it('should replace pictures alt text marker on all images and it should not modify other markers', function (done) {
          ...
          var _expected = '<xml><text:p text:style-name="P1"><text:span text:style-name="T1">Title</text:span> : {d.logo<text:span text:style-name="T1">Title</text:span>}</text:p><text:p text:style-name="P1"/><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Image1" text:anchor-type="paragraph" svg:x="0.03cm" svg:y="0.007cm" svg:width="{d.dog:scaleImageLo(width, 5.87, cm)}" svg:height="{d.dog:scaleImageLo(height, 3.302, cm)}" draw:z-index="0"><draw:image xlink:href="{d.dog:generateOpenDocumentImageHref()}" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/><svg:title></svg:title></draw:frame></text:p><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Image1" text:anchor-type="paragraph" svg:x="0.03cm" svg:y="0.007cm" svg:width="{d.cat:scaleImageLo(width, 5.87, cm)}" svg:height="{d.cat:scaleImageLo(height, 3.302, cm)}" draw:z-index="0"><draw:image xlink:href="{d.cat:generateOpenDocumentImageHref()}" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/><svg:title></svg:title></draw:frame></text:p></xml>';
          var _report = {
            embeddings : [],
            extension  : 'odt',
            files      : [
        ...
        it('should replace pictures link by alt text marker (with captions)', function (done) {
          ...
          var _expected = '<text:sequence-decls><text:sequence-decl text:display-outline-level="0" text:name="Illustration"/><text:sequence-decl text:display-outline-level="0" text:name="Table"/><text:sequence-decl text:display-outline-level="0" text:name="Text"/><text:sequence-decl text:display-outline-level="0" text:name="Drawing"/></text:sequence-decls><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Frame1" text:anchor-type="paragraph" svg:width="{d.dog:scaleImageLo(width, 17, cm)}" draw:z-index="0"><draw:text-box fo:min-height="9.562cm"><text:p text:style-name="Illustration"><draw:frame draw:style-name="fr2" draw:name="Frame2" text:anchor-type="as-char" svg:width="{d.dog:scaleImageLo(width, 17, cm)}" style:rel-width="100%" svg:height="{d.dog:scaleImageLo(height, 9.562, cm)}" style:rel-height="scale-min" draw:z-index="1"><draw:text-box><text:p text:style-name="Illustration"><draw:frame draw:style-name="fr3" draw:name="Image1" text:anchor-type="as-char" svg:width="{d.dog:scaleImageLo(width, 17, cm)}" style:rel-width="100%" svg:height="{d.dog:scaleImageLo(height, 9.562, cm)}" style:rel-height="scale" draw:z-index="2"><draw:image xlink:href="{d.dog:generateOpenDocumentImageHref()}" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/><svg:title></svg:title></draw:frame><text:span text:style-name="T1"><text:line-break/></text:span>Illustration <text:sequence text:ref-name="refIllustration1" text:name="Illustration" text:formula="ooow:Illustration+1" style:num-format="1">1</text:sequence>: and another</text:p></draw:text-box></draw:frame><text:span text:style-name="T1"><text:line-break/></text:span>Illustration <text:sequence text:ref-name="refIllustration0" text:name="Illustration" text:formula="ooow:Illustration+1" style:num-format="1">2</text:sequence>: captionned</text:p><text:p text:style-name="Text">Text <text:sequence text:ref-name="refText0" text:name="Text" text:formula="ooow:Text+1" style:num-format="1">1</text:sequence>: twice</text:p></draw:text-box></draw:frame></text:p>';
          var _report = {
            embeddings : [],
            extension  : 'odt',
            files      : [
