    ...
    describe('Dynamic pictures preprocessing ODT ONLY', function () {
      ...
      describe('prepareOpenDocumentImage', function () {
        ...
        it('should replace pictures link by alt text marker and add special formatter generateOpenDocumentImageHref', function (done) {
          ...
          var _expected = '<xml><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Image1" text:anchor-type="paragraph" svg:x="0.03cm" svg:y="0.007cm" svg:width="{d.dog:scaleImage(width, 5.87, cm, fillWidth)}cm" svg:height="{d.dog:scaleImage(height, 3.302, cm, fillWidth)}cm" draw:z-index="0">'
        ...
        it('should leave other markers in alternative text and take into account only the first marker for image', function (done) {
          ...
          var _expected = '<xml><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Image1" text:anchor-type="paragraph" svg:x="0.03cm" svg:y="0.007cm" svg:width="{d.dog:scaleImage(width, 5.87, cm, fillWidth)}cm" svg:height="{d.dog:scaleImage(height, 3.302, cm, fillWidth)}cm" draw:z-index="0"><draw:image xlink:href="{d.dog:generateOpenDocumentImageHref()}" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/><svg:title>  {d.altText}</svg:title></draw:frame></text:p></xml>';
          var _report = {
            embeddings : [],
            extension  : 'odt',
            files      : [
        ...
        it('should replace pictures alt text marker on all images and it should not modify other markers', function (done) {
          ...
          var _expected = '<xml><text:p text:style-name="P1"><text:span text:style-name="T1">Title</text:span> : {d.logoTitle}<text:span text:style-name="T1"></text:span></text:p><text:p text:style-name="P1"/><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Image1" text:anchor-type="paragraph" svg:x="0.03cm" svg:y="0.007cm" svg:width="{d.dog:scaleImage(width, 5.87, cm, fillWidth)}cm" svg:height="{d.dog:scaleImage(height, 3.302, cm, fillWidth)}cm" draw:z-index="0"><draw:image xlink:href="{d.dog:generateOpenDocumentImageHref()}" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/><svg:title></svg:title></draw:frame></text:p><text:p text:style-name="P1"><draw:frame draw:style-name="fr1" draw:name="Image1" text:anchor-type="paragraph" svg:x="0.03cm" svg:y="0.007cm" svg:width="{d.cat:scaleImage(width, 5.87, cm, fillWidth)}cm" svg:height="{d.cat:scaleImage(height, 3.302, cm, fillWidth)}cm" draw:z-index="0"><draw:image xlink:href="{d.cat:generateOpenDocumentImageHref()}" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/><svg:title></svg:title></draw:frame></text:p></xml>';
          var _report = {
            embeddings : [],
            extension  : 'odt',
            files      : [
