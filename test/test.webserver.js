...
describe.only('Webserver', () => {
  ...
  describe('Render template', () => {
    ...
    it.skip('should render template with a test token and a PDF conversion', () => {})
    it.skip('should render template with a test token and a PDF conversion with the complex format and keep user choice but override watermark', () => {})
    it.skip('should return an error if user convert with something else than what is available in the conf and have a test token', () => {})
    it.skip('should add a template by using the test api key without "Bearer" at the start of the Authorization header', () => {})
    it.skip('should not render template if x-from-proxy = true and the idAccount is not yours', () => {})
    it.skip('should not render template (unauthorized)', () => {})
  ...
  describe('Get render', () => {
    ...
    it.skip('should retrieve the render file without authentication', () => {})
    it.skip('should not retrieve the render file (unauthorized)', () => {})
  });
  ...
  describe('Add template', () => {
    ...
    it.skip('should throw auth error', () => {})
  });
});
